...
class Auth extends Component {
  ...
  onSearch = (location, lat, lng, phone) => {
    ...
    let autocompleteResult = {
      phone:
        phone !== undefined ? phone : this.state.registrationForm.phone.value,
      streetNumber:
        location.street_number !== undefined
          ? location.street_number
          : this.state.registrationForm.streetNumber.value,
      route:
        location.route !== undefined
          ? location.route
          : this.state.registrationForm.route.value,
      addressOne:
      ...
      neighborhood:
        location.neighborhood !== undefined
          ...
          : this.state.registrationForm.neighborhood.value,
      city:
        location.locality !== undefined
          ? location.locality
          : this.state.registrationForm.city.value,
      township:
        location.administrative_area_level_3 !== undefined
          ? location.administrative_area_level_3
          : this.state.registrationForm.township.value,
      county:
        location.administrative_area_level_2 !== undefined
          ? location.administrative_area_level_2
          : this.state.registrationForm.county.value,
      state:
        location.administrative_area_level_1 !== undefined
          ? location.administrative_area_level_1
          : this.state.registrationForm.state.value,
      zipcode:
        location.postal_code !== undefined
          ? location.postal_code
          : this.state.registrationForm.zipcode.value,
      zipcodeSuffix:
        location.postal_code_suffix !== undefined
          ? location.postal_code_suffix
          : this.state.registrationForm.zipcodeSuffix.value,
      country:
        location.country !== undefined
          ? location.country
          : this.state.registrationForm.country.value,
      latitude:
        lat !== undefined ? lat : this.state.registrationForm.latitude.value,
      longitude:
        lng !== undefined ? lng : this.state.registrationForm.longitude.value
    };
...
const mapDispatchToProps = dispatch => ({
  authRegister: (email, password, company) =>
    dispatch(actions.authRegister(email, password, company)),
